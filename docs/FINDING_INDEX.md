...
| 3 | `essentiality_artifact` | 139 | 139 high-Rest-reach genes mark general machinery rather than T-cell-specific regulation. |
| 4 | `cross_cell_type_transfer` | 377 | Essentiality genes replicate in K562 and RPE1; the activation module stays inert. |
